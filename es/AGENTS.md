...
### Eventos de Sync (Tabla Completa)

| Acción en Repo | Actualización en Vault | Prioridad |
|----------------|------------------------|-----------|
| Nueva fase completada | [[Implementation Progress]] + Daily Note | HIGH |
| Tests pasan | Actualizar test counts en [[Implementation Progress]] | HIGH |
| Nueva decisión arquitectónica | Nuevo ADR en `ADRs/` + [[Architecture Decisions]] | HIGH |
| Bug crítico fixeado | Documentar en Daily Note + [[Bug Tracker]] | MEDIUM |
| Nuevo endpoint/API | Actualizar [[API Documentation]] | MEDIUM |
| Refactor importante | Crear Topic + Daily Note | LOW |
| Cambio de seguridad | [[Security & Privacy]] | MEDIUM |
| Cambio en tests | [[Testing Strategy]] | LOW |

### Repo → Vault (Actualizar vault):

| Repo | Vault (MOC/Topic) |
|------------------|-------------------|
| Phase Overview table | [[Implementation Progress]] o [[Research Progress]] |
| Checklist features | [[Proyecto - TODOs]] |
| ADRs en docs/adrs/ | ADRs/ (copia) |
| Test counts | [[Implementation Progress]] + [[Testing Strategy]] |
| Commits/Changes | Daily Notes |
...
| Cambios en fases | Actualizar Phase Overview |

### Flujo Recomendado

```
1. Trabajar en código (repo)
2. Tests pasan ✅
3. Actualizar vault (Daily Note, Topics, MOCs)
...
- [ ] Vault updated:
  ...
  - [ ] Topics created/updated (si nuevo concepto)
  - [ ] MOCs updated (Implementation/Research Progress)
- [ ] ADRs created para nuevas decisiones
- [ ] Usar template [[Sync Checklist]] si necesario
